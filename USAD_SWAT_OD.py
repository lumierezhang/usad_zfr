...
windows_labels=[]
for i in range(len(labels_down)-window_size):  # （12252-12）
    windows_labels.append(list(np.int_(labels_down[i:i+window_size])))  # （449907）
...
#新加
threshold=0.176 # Decide on your own threshold
